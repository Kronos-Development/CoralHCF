...
public class PvPClassHandler extends BukkitRunnable implements Listener {
    ...
    public PvPClassHandler() {
        ...
        if (Foxtrot.getInstance().getConfig().getBoolean("pvpClasses.archer", true)) {
            pvpClasses.add(new ArcherClass());
        }

        if (Foxtrot.getInstance().getConfig().getBoolean("pvpClasses.bard", true)) {
            pvpClasses.add(new BardClass());
        }

        if (Foxtrot.getInstance().getConfig().getBoolean("pvpClasses.rogue", true)) {
            pvpClasses.add(new RogueClass());
        }

        if (Foxtrot.getInstance().getConfig().getBoolean("pvpClasses.scout", false)) {
